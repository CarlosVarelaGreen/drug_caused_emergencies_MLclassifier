...
- Glosario_Pacientes1erIngresoatratamiento.xlsx "Data dictionary for the dataset".

- pacientes1erIngresoatratamiento.csv "Original dataset downloaded from official website".

- test_samples.csv "csv file with samples to test the emergency_type_classifier.py script".

- cda_final_project_notebook.ipynb "Final notebook with EDA and model development pipeline".

- naive_bayes_model.pkl "stored pickle model from notebook"             
...
- dependencies_for_environment.txt "list of environment pip dependencies from my dev environment".